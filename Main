...
def generate_response(message):
    """
    Sends the message to Gemini API and returns the generated response.
    """
    your_api_key = ""
...
Remember, DO NOT ANSWER ANY TOPIC Other than Mental Health. Don't give out long and unecessary responses. Try responding preciesly and dont compare the person or say the reality, Be a good and lovable assistant. Now, respond to the following message with warmth and understanding: '{message}'"""
            }]
        }],
        "generationConfig": {
            "temperature": 0.7,
